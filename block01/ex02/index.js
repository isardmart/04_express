...
app.get('/:lang/:add',(req,res)=>{
    if (req.params.add&&!(langlist.includes(req.params.lang.toLowerCase()))){
        ...
        res.send({ ok: true, data: `${req.params.lang} already in DB`})
    }
})
